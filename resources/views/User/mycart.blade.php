    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      ...
      <div class="container p-5  mt-5">
          ...
          <div class="row">
            ...
            <div class="col-md-3 border-3">
                <img src="{{ asset("storage/{$product['image']}") }}" class="w-100" alt="">
                <h2>d  {{$product['name']  }}</h2>
                <h4 > Priec :<b class="text-success">   {{ $product['price'] }} $</b></h4>
                <h4> Quantity: {{$product['qut'] }}</h4>
            ...
            <div class="col-md-12 text-center">
                ...
                <form action="makeOrder" method="post">
                    @csrf
                    <input type="date" class="form-control my-3" name="day" id="">
